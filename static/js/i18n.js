(function () {
  ...
  const TEXT = {
    en: {
      ...
      "abril": "April",
      "agosto": "August",
      "ainda nao ha medias calculadas.": "There are no calculated averages yet.",
      ...
      "alunos sob responsabilidade": "Students under responsibility",
      ...
      "chamada incompleta": "Incomplete roll call",
      ...
      "digite um e-mail valido, contendo @ e dominio.": "Enter a valid email address containing @ and a domain.",
      "digite um telefone com ddd, no formato (xx)xxxxx-xxxx.": "Enter a phone number with area code, in the format (xx)xxxxx-xxxx.",
      "distribuicao de usuarios": "User distribution",
      "disciplinas": "subjects",
      "disciplinas cursando": "Subjects in progress",
      "dom": "SUN",
      "e-mail": "Email",
      ...
      "erro ao buscar dados.": "Error fetching data.",
      ...
      "esta area e exclusiva para coordenadores.": "This area is only for coordinators.",
      "evento": "Event",
      ...
      "falha na conexao.": "Connection failed.",
      "falha na conexao com o servidor.": "Connection to the server failed.",
      "fazer login": "Log in",
      "fechar": "Close",
      "fevereiro": "February",
      "filtro": "Filter",
      ...
      "frequencia media institucional.": "Institution-wide average attendance.",
      ...
      "nenhum aluno carregado para salvar.": "No student loaded to save.",
      "nenhum aluno em alerta.": "No student in alert.",
      "nenhum aluno encontrado para essa selecao.": "No student found for this selection.",
      "nenhum aluno encontrado para essa turma.": "No student found for this class.",
      "nenhum aluno matriculado.": "No enrolled student.",
      "nenhum alerta no momento.": "No alert right now.",
      "nenhuma informacao foi alterada.": "No information was changed.",
      "nenhum dado foi atualizado": "No data was updated",
      "nenhum dado foi atualizado.": "No data was updated.",
      "nenhuma materia atribuida.": "No assigned subject.",
      "nenhuma materia encontrada": "No subject found",
      "nenhuma materia encontrada para sua turma.": "No subject found for your class.",
      "nenhuma materia vinculada.": "No linked subject.",
      "nenhuma mensagem.": "No message.",
      "nenhuma turma.": "No class.",
      "nenhuma turma encontrada com esses filtros.": "No class found with these filters.",
      "nenhum registro encontrado.": "No record found.",
      "nenhum resultado encontrado": "No result found",
      "nenhum resultado para a busca.": "No result for the search.",
      "nome": "Name",
      ...
      "nota 1": "Grade 1",
      "nota 2": "Grade 2",
      "notas ainda nao lancadas pelo professor.": "Grades have not been posted by the teacher yet.",
      ...
      "o titulo deve ter no minimo 3 caracteres.": "The title must be at least 3 characters long.",
      "ocultar senha": "Hide password",
      "outubro": "October",
      "pagina inicial": "Home",
      "painel de gestao": "Management dashboard",
      "para alterar a senha, digite sua senha atual.": "To change your password, enter your current password.",
      "periodo": "Period",
      "perfil": "Profile",
      ...
      "preencha titulo e data de inicio.": "Fill in title and start date.",
      "presenca": "Attendance",
      "presencas": "Present",
      ...
      "sua sessao sera encerrada.": "Your session will be ended.",
      ...
      "verifique os dados informados.": "Check the provided data.",
      ...
      "nao foi possivel alterar": "Unable to change",
      ...
      "chamada salva com sucesso.": "Attendance saved successfully.",
      "colegas de turma": "Classmates",
      "confira os dados antes de confirmar o envio.": "Check the data before confirming.",
      "coordenador": "Coordinator",
      "criado por mim": "Created by me",
      ...
      "falha na conexao com o servidor.": "Server connection failure.",
      "faltando:": "Missing:",
      ...
      "minhas materias": "My subjects",
      "minhas notas": "My grades",
      "nao foi possivel conectar ao servidor.": "Unable to connect to the server.",
    ...
    es: {
      ...
      "abaixo do minimo exigido de 75%": "Por debajo del mínimo exigido de 75%",
      ...
      "atencao": "Atención",
      "atencao a frequencia": "Atención a la asistencia",
      ...
      "chamada salva com sucesso.": "Asistencia guardada con éxito.",
      "codigo": "Código",
      "codigo:": "Código:",
      ...
      "digite um e-mail valido, contendo @ e dominio.": "Escribe un correo válido, con @ y dominio.",
      "digite um telefone com ddd, no formato (xx)xxxxx-xxxx.": "Escribe un teléfono con código de área, en formato (xx)xxxxx-xxxx.",
      ...
      "erro ao carregar alunos.": "Error al cargar estudiantes.",
      ...
      "erro ao carregar materias.": "Error al cargar asignaturas.",
      ...
      "erro ao salvar evento.": "Error al guardar evento.",
      ...
      "falha ao buscar alunos.": "Fallo al buscar estudiantes.",
      ...
      "falha ao buscar turmas.": "Fallo al buscar grupos.",
      "falha ao carregar eventos.": "Fallo al cargar eventos.",
      "falha ao carregar dados do usuario.": "Fallo al cargar datos del usuario.",
      ...
      "informe seu e-mail e sua senha.": "Informa tu correo y contraseña.",
      ...
      "informe uma data e hora de fim valida.": "Informa una fecha y hora de fin válida.",
      "informe uma data e hora de inicio valida.": "Informa una fecha y hora de inicio válida.",
      "inativo": "Inactivo",
      ...
      "leciona": "enseña",
      "limpar": "Limpiar",
      "login realizado!": "¡Inicio de sesión realizado!",
      ...
      "mais": "más",
      "media": "Promedio",
      "media abaixo de 5,0": "Promedio inferior a 5,0",
      ...
      "nao foi possivel atualizar o perfil.": "No fue posible actualizar el perfil.",
      "nao foi possivel carregar os dados do perfil.": "No fue posible cargar los datos del perfil.",
      "nao foi possivel conectar ao servidor.": "No fue posible conectar con el servidor.",
      "nenhum aluno carregado para salvar.": "No hay estudiantes cargados para guardar.",
      ...
      "nenhum aluno encontrado para essa turma.": "No se encontró ningún estudiante para este grupo.",
      "nenhum aluno matriculado.": "Ningún estudiante matriculado.",
      "nenhum alerta no momento.": "Ninguna alerta en este momento.",
      "nenhuma informacao foi alterada.": "Ninguna información fue modificada.",
      "nenhum dado foi atualizado": "Ningún dato fue actualizado",
      "nenhum dado foi atualizado.": "Ningún dato fue actualizado.",
      "nenhuma materia atribuida.": "Ninguna asignatura atribuida.",
      ...
      "nenhum resultado para a busca.": "Ningún resultado para la búsqueda.",
      "nome": "Nombre",
      ...
      "nota 1": "Nota 1",
      "nota 2": "Nota 2",
      "notas ainda nao lancadas pelo professor.": "Notas aún no publicadas por el profesor.",
      ...
      "para alterar a senha, digite sua senha atual.": "Para cambiar la contraseña, escribe tu contraseña actual.",
      "periodo": "Periodo",
      "perfil": "Perfil",
      ...
      "pesquise e selecione um aluno da lista.": "Busca y selecciona un estudiante de la lista.",
      "pesquise e selecione uma materia da lista.": "Busca y selecciona una asignatura de la lista.",
      "pesquise e selecione um professor da lista.": "Busca y selecciona un profesor de la lista.",
      ...
      "preencha titulo e data de inicio.": "Completa título y fecha de inicio.",
      "presenca": "Asistencia",
      "presencas": "Presentes",
      ...
      "selecione a data da aula.": "Selecciona la fecha de la clase.",
      ...
      "sua sessao sera encerrada.": "Tu sesión se cerrará.",
      ...
      "verifique os dados informados.": "Verifica los datos informados.",
      ...
      "essa acao nao podera ser desfeita.": "Esta acción no se podrá deshacer.",
      ...
      "confira os dados antes de confirmar o envio.": "Verifica los datos antes de confirmar.",
      "coordenador": "Coordinador",
      "criado por mim": "Creado por mí",
      ...
      "falha na conexao com o servidor.": "Fallo en la conexión con el servidor.",
      "faltando:": "Faltando:",
      ...
      "minhas materias": "Mis asignaturas",
      "minhas notas": "Mis notas",
      "nao foi possivel conectar ao servidor.": "No fue posible conectar al servidor.",
      "nenhum alerta no momento.": "Ninguna alerta por el momento.",
      "nenhum aluno carregado para salvar.": "Ningún estudiante cargado para guardar.",
      "nenhum aluno em alerta.": "Ningún estudiante en alerta.",
      ...
      "nenhuma materia encontrada para sua turma.": "Ninguna asignatura encontrada para tu grupo.",
      "nenhuma mensagem enviada.": "Ningún mensaje enviado.",
      "nenhuma mensagem recebida.": "Ningún mensaje recibido.",
      ...
      "salvando...": "Guardando...",
      "seg": "Lun",
      "selecione a data da aula.": "Selecciona la fecha de clase.",
      ...
      "carregando sua turma": "Cargando tu clase...",
      "carregando turmas": "Cargando clases...",
      "chamada": "Lista",
      ...
      "erro ao carregar turmas": "Error al cargar clases",
      "escreva a mensagem": "Escriba el mensaje",
      "excluir materia": "Eliminar materia",
      "falha na conexao com o servidor": "Fallo de conexión con el servidor",
      "gerencie alunos materias e professores": "Gestiona alumnos, materias y profesores",
      ...
      "notas publicadas": "Calificaciones publicadas",
      ...
      "sem materias cadastradas": "Sin materias registradas",
      "situacao": "Situación",
      ...
      "falha de conexao tente novamente": "Fallo de conexión. Inténtalo de nuevo.",
      "materia removida": "Materia eliminada",
      ...
      "nenhuma materia cadastrada ainda": "Aún no hay materias registradas",
      ...
      "nenhuma materia vinculada": "No hay materias vinculadas",
      "erro ao carregar dados": "Error al cargar datos",
      "sem professor": "Sin profesor",
      "professor(es)": "Profesor(es)",
      "nenhuma turma encontrada com esses filtros": "No se encontraron clases con estos filtros",
      "alunos matriculados · materias e professores": "Alumnos matriculados · Materias y profesores",
      "carregando alunos": "Cargando alumnos...",
      "selecionar turma": "Seleccionar clase",
      "selecionar materia": "Seleccionar materia",
      ...
      "turma excluida!": "¡Clase eliminada!",
      "matriculado!": "¡Matriculado!",
      "materia vinculada!": "¡Materia vinculada!",
      "atribua um professor abaixo se necessario.": "Asigne un profesor a continuación si es necesario.",
      ...
      "erro ao excluir turma.": "Error al eliminar la clase.",
      "sera desvinculado dessa turma.": "será desvinculado de esta clase.",
      "deseja desmatricular": "¿Dar de baja al alumno?",
      "desvincular": "Desvincular",
      "professor removido": "Profesor eliminado",
      "turma criada": "Clase creada",
      "turma atualizada": "Clase actualizada",
      "turma criada com sucesso!": "¡Clase creada exitosamente!",
      "turma atualizada com sucesso!": "¡Clase actualizada exitosamente!",
      "turma editada com sucesso!": "¡Clase actualizada exitosamente!",
      "prefixo invalido.": "Prefijo no válido.",
      "nome do curso invalido.": "Nombre del curso no válido.",
      "a turma sera desativada esta acao nao pode ser desfeita.": "La clase será desactivada. Esta acción no se puede deshacer.",
      "selecione curso professor turma e materia para visualizar as notas": "Seleccione curso, profesor, clase y materia para ver calificaciones",
      "selecione curso materia e turma para registrar as notas": "Seleccione curso, materia y clase para registrar calificaciones",
      ...
      "reuniao": "Reunión",
      "outro": "Otro",
      "o nome deve ter no minimo 3 caracteres": "Name must be at least 3 characters",
      "informe um cpf valido": "Enter a valid CPF",
      "informe um e-mail valido": "Enter a valid email",
      "informe um telefone valido com ddd": "Enter a valid phone number with area code",
      "informe a data de nascimento": "Enter the date of birth",
      "informe um salario valido no formato 0,00": "Enter a valid salary in the format 0.00",
      "nenhuma informacao foi alterada": "No information was changed",
      ...
      "media abaixo de 5,0": "Promedio por debajo de 5,0",
      "selecione curso materia turma e aluno para visualizar a frequencia": "Seleccione curso, materia, clase y alumno para ver asistencia",
